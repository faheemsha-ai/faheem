...
class Address(models.Model):
    cart_total = models.ForeignKey(CartItem, on_delete=models.CASCADE)
    user_address = models.ForeignKey(User, on_delete=models.CASCADE) 
    address = models.TextField(max_length=600,blank=False)
    ...
    nearby_landmark = models.CharField(max_length=90,blank=False)
